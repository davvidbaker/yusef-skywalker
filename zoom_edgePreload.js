...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="550px",plHeight="500px";

preContent={
    dom: [
    {
        id: 'dancing-spiderman',
        type: 'image',
        tag: 'img',
        rect: ['211px', '186px','128px','128px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/dancing-spiderman.gif','0px','0px']
    }]};//simpleContent
